...
namespace FlightManagement.Model
{
    class CTDTThang
    {
        public CTDTThang(string MACB, int SOVE, float TYLETUNGCHUYENBAY, int DOANHTHU, int THANG, int NAM)
        {
        ...
        public CTDTThang(DataRow row)
        {
            ...
            this.Tyletungchuyenbay = float.Parse(row["TyLeTungCB"].ToString());
        ...
        public float Tyletungchuyenbay { get => tyletungchuyenbay; set => tyletungchuyenbay = value; }
